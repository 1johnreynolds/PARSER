...
public class XMLUtils {
    ...
    public static void main (String args[]) throws Exception{
        ...
        System.out.println(XMLUtils.validateWithDTDUsingDOM("./src/dblp-soc-papers.xml"));
        System.out.println(XMLUtils.validateWithDTDUsingSAX("./src/dblp-soc-papers.xml"));
    /*
      output :
               true
               true
